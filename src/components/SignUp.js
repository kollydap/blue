                ...
                <div className='account-right'>
                  ...
                  <div className='form-col-input'>
                      <div className='form-group'>
                          <input placeholder='Firstname' className='form-control' name='first_name' onChange={handleChange} required />
                      </div>
                  </div>
                  <div className='form-col-input'>
                      <div className='form-group'>
                          <input placeholder='Lastname' className='form-control' name='last_name' onChange={handleChange} required />
                      </div>
                  </div>
                  ...
                  <div className='form-col-input'>
                      <div className='form-group'>
                          <input placeholder='email' type="email" className='form-control' name='email' onChange={handleChange} required />
                      </div>
                  </div>
                  ...
                  <div className='form-col-input'>
                    ...
                    <button className='account-but' onClick={createUser}>SignUp</button>
